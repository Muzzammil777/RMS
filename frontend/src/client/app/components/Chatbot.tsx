...
export default function Chatbot({ onNavigateToMenu, onAddToCart, isLoggedIn, onNavigate }: ChatbotProps) {
  ...
  const handleBrowseMenu = () => {
    ...
    // Add back button
    categoryButtons.push({ label: '🔙 Back to Main Menu', action: 'back_to_main' });
  ...
  const handleBrowseCuisines = () => {
    ...
    // Add back button
    cuisineButtons.push({ label: '🔙 Back to Main Menu', action: 'back_to_main' });
  ...
  const handleOffers = () => {
    ...
    offerButtons.push({ label: '🔙 Back to Main Menu', action: 'back_to_main' });
